...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (function buildCoverageIcons() {
    ...
    const mapLocations = [
      ...
      ['בית שמש', 'building', 56.4, 42.5], ['בית שמש', 'house', 59.6, 42.7],
      ['בית שמש', 'building', 56.4, 45.5], ['בית שמש', 'house', 59.6, 45.6],

      ['אשקלון', 'building', 33.4, 54.5], ['אשקלון', 'house', 36.6, 54.7],
      ['אשקלון', 'building', 33.4, 57.5], ['אשקלון', 'house', 36.6, 57.6],
      ...
      ['רחובות', 'house', 43.7, 34.0], ['רחובות', 'building', 46.3, 36.0]
    ];
