...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (function buildCoverageIcons() {
    ...
    const mapLocations = [
      ['תל אביב', 'building', 27.0, 33.0], ['תל אביב', 'house', 31.2, 33.0],
      ['תל אביב', 'building', 35.0, 33.0], ['תל אביב', 'house', 27.6, 37.0],
      ['תל אביב', 'building', 31.8, 37.0], ['תל אביב', 'house', 36.0, 37.0],
      ['תל אביב', 'building', 27.0, 41.0], ['תל אביב', 'house', 31.2, 41.0],
      ['תל אביב', 'building', 35.0, 41.0],

      ['רמת גן', 'building', 40.5, 27.0], ['רמת גן', 'house', 44.7, 27.0],
      ['רמת גן', 'building', 48.9, 27.0], ['רמת גן', 'house', 42.6, 31.4],
      ['רמת גן', 'building', 46.8, 31.4], ['רמת גן', 'house', 51.0, 31.4],

      ['הרצליה', 'building', 24.5, 24.0], ['הרצליה', 'house', 23.5, 21.3],
      ['הרצליה', 'building', 28.5, 21.8], ['הרצליה', 'house', 23.8, 27.2],
      ['הרצליה', 'building', 29.0, 27.3],

      ['פתח תקווה', 'building', 52.5, 26.0], ['פתח תקווה', 'house', 50.0, 24.0],
      ['פתח תקווה', 'building', 56.0, 24.5], ['פתח תקווה', 'house', 50.5, 29.0],
      ['פתח תקווה', 'building', 55.5, 29.5],

      ['בת ים', 'building', 30.0, 46.5], ['בת ים', 'house', 35.5, 46.8],
      ['בת ים', 'building', 30.3, 50.5], ['בת ים', 'house', 38.0, 50.0],

      ['בית שמש', 'building', 52.5, 46.0], ['בית שמש', 'house', 59.0, 46.3],
      ['בית שמש', 'building', 53.0, 50.3], ['בית שמש', 'house', 59.5, 50.6],

      ['אשקלון', 'building', 39.5, 63.5], ['אשקלון', 'house', 46.5, 61.7],
      ['אשקלון', 'building', 40.5, 67.5], ['אשקלון', 'house', 47.0, 66.6],

      ['אשדוד', 'building', 33.0, 53.0], ['אשדוד', 'house', 40.0, 52.8],
      ['אשדוד', 'building', 36.5, 57.5],

      ['חולון', 'house', 39.0, 42.5], ['חולון', 'building', 42.0, 44.5],
      ['ראשון לציון', 'building', 36.0, 51.0], ['ראשון לציון', 'house', 39.0, 53.0],
      ['רחובות', 'house', 46.0, 56.5], ['רחובות', 'building', 49.5, 59.0]
    ];
